                ...
                <div>
                    ...
                    <div class="mb-3 mt-3">
                        <form action="servicospost.php" method="post">
                            <label class="form-label" for="fname"> Nome Completo: </label><br>
                            <input class="form-control" type="text" id="name" name="name"><br>
                            
                            <label class="form-label" for="lname"> Email:</label><br>
                            <input class="form-control" type="text" id="email" name="email"><br>
                            
                            <label class="form-label" for="data">CPF</label><br>
                            <input class="form-control" type="text" id="cpf" name="cpf"><br>
                            
                            <label class="form-label" for="hora">Endereço</label><br>
                            <input class="form-control" type="text" id="lname" name="lname"><br>

                            <label class="form-label" for="hora">Telefone</label><br>
                            <input class="form-control" type="text" id="telefone" name="telefone"><br>
                            
                            <label class="form-label" for="hora">CNPJ</label><br>
                            <input class="form-control" type="text" id="cnpj" name="cnpj"><br>
                            
                            <input id="cadastrar" type="submit" name="cadastrar">
                        </form>
                    </div>
